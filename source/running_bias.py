...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  3 14:09:54 2020
...
while firstobj != lastobj:
    ...
    NUCAPS_archive = '/data/COALITION2/PicturesSatellite/results_NAL/'
    ...
    #NUCAPS_data = open_NUCAPS_file(NUCAPS_archive+'/NUCAPS_Stuttgart_-60min_0min_3500km.nc')
    #NUCAPS_data = open_NUCAPS_file(NUCAPS_archive+'/NUCAPS_Munich_-60min_0min_3500km.nc')
    #NUCAPS_data = open_NUCAPS_file(NUCAPS_archive+'/NUCAPS_Milano_-120min_0min_3500km.nc')
    # !!!!! find correct  !!!!!
    ...
    RM_data['time_YMDHMS'] = RM_data.time_YMDHMS.dt.round('5min').values
    #RM_data = RM_data.groupby(['time_YMDHMS', 'altitude_m'])[['dew_point_degC', 'temperature_K', 'temperature_degC']].mean().reset_index()
    RM_data.temperature_degC[RM_data.rain_flag != 0] = np.nan
    #RM_data.temperature_K[RM_data.rain_flag != 0] = np.nan
    ...
    NUCAPS_smoothed_INCA_all_minbias_30days = NUCAPS_smoothed_INCA_all_minbias_30days[['altitude_m', 'temperature_mean', 'temperature_d_mean']]
    ...
    ### bias correced ###
    ax1.plot(std_temp_NUCAPS_all_minbias_0days.std_temp, std_temp_NUCAPS_all_minbias_0days.altitude_m, color = 'red', linewidth = 3, label = 'T NUCAPS, min bias 0 days', zorder = 0)
    ax1.plot(std_temp_d_NUCAPS_all_minbias_0days.std_temp_d, std_temp_NUCAPS_all_minbias_0days.altitude_m, color = 'red', linewidth = 3, label = 'Td NUCAPS, min bias 0 days', linestyle = '--',zorder = 1)

    ax1.plot(std_temp_NUCAPS_all_minbias_3days.std_temp, std_temp_NUCAPS_all_minbias_3days.altitude_m, color = 'green', linewidth = 3, label = 'T NUCAPS, min bias 3 days', zorder = 0)
    ax1.plot(std_temp_d_NUCAPS_all_minbias_3days.std_temp_d, std_temp_NUCAPS_all_minbias_3days.altitude_m, color = 'green', linewidth = 3, label = 'Td NUCAPS , min bias 3 days', linestyle = '--',zorder = 1)

    ax1.plot(std_temp_NUCAPS_all_minbias_7days.std_temp, std_temp_NUCAPS_all_minbias_7days.altitude_m, color = 'orange', linewidth = 3, label = 'T NUCAPS, min bias 7 days', zorder = 0)
    ax1.plot(std_temp_d_NUCAPS_all_minbias_7days.std_temp_d, std_temp_NUCAPS_all_minbias_7days.altitude_m, color = 'orange', linewidth = 3, label = 'Td NUCAPS, min bias 7 days', linestyle = '--',zorder = 1)

    ax1.plot(std_temp_NUCAPS_all_minbias_30days.std_temp, std_temp_NUCAPS_all_minbias_30days.altitude_m, color = 'navy', linewidth = 3, label = 'T NUCAPS, min bias 30 days', zorder = 0)
    ax1.plot(std_temp_d_NUCAPS_all_minbias_30days.std_temp_d, std_temp_NUCAPS_all_minbias_30days.altitude_m, color = 'navy', linewidth = 3, label = 'Td NUCAPS, min bias 30 days', linestyle = '--',zorder = 1)
